...
public class ExtraSECamaron extends EDSushiEnsalada {

	public ExtraSECamaron(InterSushiEnsalda sushi) {
		super(sushi);
	...
	public String getNombre() {
		return sushi.getNombre() + " + camarón";
	}
	...
	public ArrayList<String> getIngredientes() {
		...
		if (!ingredientes.contains("camarón")) {
			ingredientes.add("camarón");
		}
		return ingredientes;
	}
