...
public class ExtraCSalsaBBQ extends EDComida {

	public ExtraCSalsaBBQ(InterComida comida) {
		super(comida);
	}
	...
	public String getNombre() {
		return comida.getNombre() + " + salsa BBQ";
	}
	...
	public ArrayList<String> getIngredientes() {
		...
		if (!ingredientes.contains("salsa bbq")) {
	...
	public ArrayList<String> getExtras() {
		...
		if (!extras.contains("salsa BBQ")) {
			extras.add("salsa BBQ");
		}
		return extras;
	}
}